...
## Compression Worker LLM

```text
You have received one block of code to compress into a small, recoverable component description.
...
## Decompression Worker LLM

```text
You rebuild source files from compressed component descriptions.
